...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfZeroBooks() {
        //Given
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "89012345678");
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOf0Books = new ArrayList<Book>();
    ...
    public void testListBooksInHandsOfOneBook() {
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(resultListOf1Book);
        //When
        List<Book> result = bookLibrary.listBooksInHandsOf(libraryUser);
        //Then
